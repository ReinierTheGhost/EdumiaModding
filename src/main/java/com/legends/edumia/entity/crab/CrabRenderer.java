package com.legends.edumia.entity.crab;

import com.google.common.collect.Maps;
import com.legends.edumia.Edumia;
import com.legends.edumia.entity.model.ModEntityModelLayers;
...
public class CrabRenderer extends MobEntityRenderer<CrabEntity, CrabModel> {
    ...
    public Identifier getTexture(CrabEntity entity) {
        return new Identifier(Edumia.MOD_ID, LOCATION_BY_VARIANT.get(entity.getVariant()));
    }
