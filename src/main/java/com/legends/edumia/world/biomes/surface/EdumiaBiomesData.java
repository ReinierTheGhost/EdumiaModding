...
public class EdumiaBiomesData {
    ...
    public static void loadBiomes() {
        ...
        frozenPond = new EdumiaBiome(-10, EdumiaBiomeKeys.FROZEN_POND,  Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.STONE, CaveType.FOROD);
        oasis = new EdumiaBiome(-10, EdumiaBiomeKeys.OASIS,  Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.STONE, CaveType.HARAD);
        ...
        addBiome(new Color(101, 123, 243), new EdumiaBiome(-11, EdumiaBiomeKeys.FROZEN_OCEAN, Blocks.GRAVEL, Blocks.ICE, Blocks.STONE, CaveType.FOROD));
        ...
        addBiome(new Color(255, 0, 110), new EdumiaBiome(-11, EdumiaBiomeKeys.GENSAI_REEF, Blocks.SAND, Blocks.STONE, Blocks.STONE));
        ...
        addBiome(new Color(234, 222, 117), new EdumiaBiome(6, EdumiaBiomeKeys.GENSAI_BEACH, Blocks.GRASS_BLOCK, Blocks.SANDSTONE, Blocks.STONE, CaveType.HARAD));
        ...
        addBiome(new Color(236, 236, 236), new EdumiaBiome(14, EdumiaBiomeKeys.EDUMIA_TUNDRA, Blocks.SNOW_BLOCK, Blocks.SNOW_BLOCK, Blocks.ICE, CaveType.FOROD));
        addBiome(new Color(237, 229, 145), new EdumiaBiome(9, EdumiaBiomeKeys.ORC_DESERT, Blocks.SAND, Blocks.SAND, Blocks.SANDSTONE, CaveType.HARAD));
        ...
        addBiome(new Color(36, 31, 31), new EdumiaBiome(47, EdumiaBiomeKeys.GENSAI_VOLCANO, StoneSets.VOLCANIC_ROCK.block(), StoneSets.VOLCANIC_ROCK.block(), StoneSets.VOLCANIC_ROCK.block(), CaveType.ASHEN));

        addBiome(new Color(75, 106, 199), new EdumiaBiome(-12, EdumiaBiomeKeys.OCEAN_COAST, Blocks.SAND, Blocks.STONE, Blocks.STONE));
