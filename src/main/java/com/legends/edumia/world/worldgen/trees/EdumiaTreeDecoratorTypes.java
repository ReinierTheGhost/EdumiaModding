...
public class EdumiaTreeDecoratorTypes {
    ...
    public static final TreeDecoratorType<?> HANGING_BRANCH_DECORATOR = TreeDecoratorTypeInvoker.callRegister("hanging_branch_decorator",
            HangingBranchDecorator.CODEC);
