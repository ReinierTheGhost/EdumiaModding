...
public class TemperateTreeConfiguredFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> BIRCH_TREE_KEY = registerKey("tree/temperate/birch/birch_tree");
    public static final RegistryKey<ConfiguredFeature<?, ?>> MEGA_BIRCH_TREE_KEY = registerKey("tree/temperate/birch/mega_birch_tree");

    public static final RegistryKey<ConfiguredFeature<?, ?>> BLACKTHORN_TREE_KEY = registerKey("tree/temperate/blackthorn/blackthorn_tree");
